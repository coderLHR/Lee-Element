...
//     // class
//     expect(wrapper.classes()).toContain("lee-button--primary");
...
//       });
//       expect(wrapper.classes()).toContain(`lee-button--${type}`);
//     });
//   });
...
//       });
//       expect(wrapper.classes()).toContain(`lee-button--${size}`);
//     });
//   });
...
//     expect(wrapper.classes()).toContain("lee-button-group");
//   });
...
//       expect(buttonWrapper.classes()).toContain(`lee-button--${size}`);
//     });
//   });
...
//       const buttonWrapper = wrapper.findComponent(Button);
//       expect(buttonWrapper.classes()).toContain(`lee-button--${type}`);
//     });
//   });
